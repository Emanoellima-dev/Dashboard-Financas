...
fig1 = px.pie(tipo_movimentacao, names="Tipo", values="Quantidade de Movimentacoes", hole=0.5, title="Recebimentos VS Pagamentos")
fig1.update_layout(
   plot_bgcolor="rgba(255, 255, 255, 0)",
   paper_bgcolor="rgba(255, 255, 255, 0.3)"
  )
  
fig2 = px.bar(Bancos, x="Banco", y="qtd de vendas", title="vendas por bancos")
fig2.update_layout(
   plot_bgcolor="rgba(255, 255, 255, 0)",
   paper_bgcolor="rgba(255, 255, 255, 0.3)"
  )
...
fig3 = px.line(movimentacoes, x="data da movimentacao", y="qtd de movimentacoes", title="movimentações ao longo do ano")
fig3.update_layout(
   plot_bgcolor="rgba(255, 255, 255, 0)",
   paper_bgcolor="rgba(255, 255, 255, 0.3)"
  )
